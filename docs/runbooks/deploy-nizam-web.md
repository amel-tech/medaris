...
|---|---|
| Release created, tag `nizam-web-v1.4.0` | `1.4.0`, `latest`, `sha-<short>`, `stable` |
| Release created, tag `nizam-web-something-without-v` | `latest`, `sha-<short>`, `stable` — **no version tag** |

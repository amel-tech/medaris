...
export const EditableTextarea: React.FC<{
  ...
  return (
    <Textarea
      ...
      disabled={disabled}
      className={cn(
        "border border-transparent shadow-none focus-visible:ring-0 p-1 hover:border hover:border-gray-200 resize-none",
        className
      )}
    ></Textarea>
  );
...
export function createTextareaColumn<TData extends Record<string, any>>(

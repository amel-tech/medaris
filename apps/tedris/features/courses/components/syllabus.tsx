...
export const LessonRow = ({
  ...
  return (
    <div className="flex items-center gap-3.5 py-2 pl-6 pr-4">{inner}</div>
  );
};
  ...
  const headerInner = (
    <>
      ...
      <div className="flex items-center gap-4 text-xs text-muted-foreground">
        <span>
          {t("CoursePage.lessonsCount", { count: week.lessons.length })}
        </span>
        {collapsible && (
          <CaretDown
            size={14}
        ...
        <div className="border-b px-6 py-5">
          <div className="mb-3 flex items-start justify-between">
            ...
            <div className="flex gap-2">
              ...
              >
                <DownloadSimple size={14} /> {t("SyllabusModal.downloadPdf")}
              </button>
              <button
                type="button"

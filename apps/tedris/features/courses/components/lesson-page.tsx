  ...
  return (
    <div className="pb-16">
      ...
      <div className="mb-5 flex items-center gap-4 border-b pb-4">
        ...
        >
          <ArrowLeft size={15} /> {t("LessonPage.backToCourse")}
        </Link>
            ...
            <div className="p-5">
              <div className="mb-1.5 flex flex-wrap items-center gap-2">
                <span className="inline-flex items-center gap-1.5 rounded-full bg-red-50 px-2.5 py-0.5 text-[11px] font-semibold text-red-600">
                  <Headset size={12} /> {t("LessonTypes.LIVE")}
                </span>
                {scheduledAt && (
              ...
              {lesson.meetingUrl ? (
                <>
                  ...
                  <div className="mb-4 flex items-center gap-3 rounded-xl border bg-slate-50 px-3.5 py-3">
                    ...
                    >
                      <Copy size={13} /> {t("LessonPage.copyLink")}
                    </button>
                  </div>
                  ...
                  <div key={i} className="flex gap-3.5">
                    <div className="flex flex-col items-center">
                      <span
                        ...
                        style={{
                          background:
                            i === 0 ? platform.color : "var(--border)",
                        }}
                      />
                      {i < lesson.agenda!.length - 1 && (
                        <span className="my-1 w-px flex-1 bg-border" />
                      )}
                    </div>
                    <div
                      className={cn(i < lesson.agenda!.length - 1 && "pb-4")}
                    >
                      <div

  ...
  return (
    <header className="relative pt-24 pb-32 overflow-hidden bg-background-light">
      <div
        ...
        style={{
          backgroundImage: "url(/images/background/hero/sher-dor.png)",
          backgroundSize: "60%",
        }}
      />
      <div className="max-w-5xl mx-auto px-4 text-center relative z-10">
        ...
        <div className="flex justify-center">
          ...
          >
            {t("cta")}
            <ArrowIcon
              className="ms-2 transition-transform group-hover:ltr:translate-x-1 group-hover:rtl:-translate-x-1"
              size={20}
            />
          </a>
        </div>
